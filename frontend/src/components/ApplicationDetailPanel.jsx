    ...
    <div className="fixed inset-0 z-20 flex justify-end bg-black/20" onClick={onClose}>
      ...
      >
        <div className="flex items-start justify-between">
          <div>
            <h2 className="text-lg font-medium text-slate-900">{application.company}</h2>
        ...
        <div className="mt-6">
          ...
          <p className="mt-1 text-sm capitalize text-slate-700">{application.status}</p>
        </div>
        ...
        <div className="mt-4">
          ...
          <textarea
            ...
            className="mt-1 w-full rounded-md border border-slate-200 p-2 text-sm text-slate-700 focus:border-accent-500 focus:outline-none"
          />
        </div>
      </div>
    </div>
